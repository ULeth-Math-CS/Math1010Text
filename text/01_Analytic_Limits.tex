...
\mnote{.7}{The rigorous definition of limits is often known as the ``$\varepsilon$ -- $\delta$ definition of the limit. You might have a few brief encounters with this definition as you make your way through the calculus sequence, but a careful treatment of limits is usually not encountered until Math 3500.}
