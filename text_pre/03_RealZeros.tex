...
\mtable{.6}{Two views of $y=f(x)=x^4+x^2-12$}{fig:realzero3}{
\begin{tabular}{c}
...
\example{polyeqineqexample}{Using real zeros to solve a polynomial equation and inequality}{
\begin{enumerate}
...
\]
This time, trying $x=\pm 1$ in the quotient $q_2(x) = 2x^3+x^2+6x+3$ gets us $q_2(1) = 12\neq 0$ and $q_2(-1) = -4\neq 0$, so neither value is a zero; however, since $q_2(-1)<0$ and $q_2(1)>0$, the Intermediate Value Theorem guarantees us a zero between $-1$ and $1$. Trying possible rational roots first, we find 
\[
q_2\left(\frac{1}{2}\right)= \frac{13}{2}\neq 0$, but $q_2\left(-\frac{1}{2}\right) = 2\left(-\frac{1}{8}\right)+\frac{1}{4}+6\left(-\frac{1}{2}\right)+3 = -\frac{1}{4}+\frac{1}{4}-3+3=0,
\]
