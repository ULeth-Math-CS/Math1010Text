...
\mfigure[width=0.95\marginparwidth]{.2}{Solving $3\operatorname{arcsec}(2x-1)+\pi=2\pi$}{fig:trigeg4-3}{figures/IntroTrigGraphics/TrigEquIneq21}
...
\mfigure[width=0.95\marginparwidth]{.8}{Solving $4\arctan^2(x)-3\pi\arctan(x)-\pi^2=0$}{fig:trigeg4-4}{figures/IntroTrigGraphics/TrigEquIneq22}
...
\mtable{.55}{Solving $\pi^2-4\arccos^2(x)<0$}{fig:trigeg4-5}{
\begin{tabular}{c}
...
\mtable{.25}{Solving $4\operatorname{arccot}(3x)>\pi$}{fig:trigeg4-6}{
\begin{tabular}{c}
