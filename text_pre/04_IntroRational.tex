...
\mtable{.65}{Graphs of the three functions in Example \ref{haexample}}{fig:ratgr8}{
\begin{tabular}{c}
...
\mnote{.3}{Though the population in Example \ref{ex_fluspread} is more accurately modelled with the functions in Chapter \ref{ExpLogs}, we can approximate it (using Calculus, of course!) using a rational function.}
...
\mtable{.82}{The long-term behaviour of $N(t)$}{fig:rattab5}{
\begin{tabular}{|r||c|}  \hline
  $t$ & $N(t)$  \\ \hline
